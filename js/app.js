const WEEKS = {
  f1: {
    ...
    days: [
      ...
      { n: 'Dia 4', b: 'ba', bl: 'Acordes', t: '30 min', warm: 'Campo harmônico de C maior em tríades, todas as inversões, subindo o braço', sess: [['Encadeamentos de inversões', 'Movimentação suave entre acordes usando inversões', 'p.28-29'], ['Prática: progressão em todas as tonalidades', 'I-IV-V em C, G, D, A, E, F, B♭', 'p.30'], ['Análise de música real', 'Pegue uma música simples e identifique as tríades', 'p.31']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Progressão 4: Dm7 → Em7(11) → G7(♯5) → C7M(9)', img: '/images/dia-01/page-18-ref.jpg', notes: 'D-F-A-C; E-G-B-D-A; G-B-D#-F; C-E-G-B-D' }] }], tip: 'Escolha uma música que você goste e que tenha poucos acordes. Tente tocar só com tríades e inversões.' },
      { n: 'Dia 5', b: 'ba', bl: 'Acordes', t: '30 min', warm: 'Revisão livre: toque tríades em diferentes regiões do braço sem olhar cifras', sess: [['Consolidação das inversões', 'Refazer todos os exemplos das páginas anteriores sem consultar', 'p.14-31'], ['Teste de prontidão', 'Consegue tocar qualquer tríade em qualquer inversão sem pensar?', 'p.31'], ['Preparação para tétrades', 'Compreender que vamos adicionar a 7ª agora', 'p.32']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Progressão 5: Dm7(b5) → G7 → Cm7', img: '/images/dia-01/page-18-ref.jpg', notes: 'D-F-A-C; G-B-D-F; C-Eb-G-Bb' }] }], tip: 'Se não conseguir tocar de cor, volte atrás. Melhor consolidar pouco do que avançar com lacunas.', quiz: true },
      { n: 'Sábado', off: true },
      { n: 'Domingo', off: true },
      { n: 'Dia 6', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Tríades + agora adicionar a 7ª maior em cima (CEG → CEGB)', sess: [['Tétrade maior com 7ª maior (Cmaj7)', 'Fórmula: 1-3-5-7. Som característico, estável', 'p.33-34'], ['Inversões de tétrades', 'Fundamental, 1ª, 2ª, 3ª inversão. Baixo define a inversão', 'p.35-36'], ['Digitações comuns', 'Formas fechadas e abertas de maj7', 'p.37']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Formação 1-7-3-5 (7M)', img: '/images/dia-06/formacao-4-1-7m.png', notes: 'C-E-G-B' }, { label: 'Formação 1-5-7-3 (7M)', img: '/images/dia-06/formacao-4-2-7m.png', notes: 'C-E-G-B' }] }, { sessionIndex: 1, items: [{ label: 'Inversões Tipo 7M', img: '/images/dia-06/inversao-forma-1-7m.png', notes: 'C-E-G-B' }] }], tip: 'A 7ª maior "flutua". Você vai ouvir isso em bossa nova o tempo todo.' },
      { n: 'Dia 7', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Sequência Cmaj7-Dm7-G7-Cmaj7 em loop, explorando inversões', sess: [['Acorde dominante (G7)', 'Fórmula: 1-3-5-♭7. Função: tenso, quer resolver', 'p.38-39'], ['Acorde menor com 7ª menor (Dm7)', 'Fórmula: 1-♭3-5-♭7. Som suave, contexto de ii-V-I', 'p.40-41'], ['Acorde meio-diminuto (Bm7♭5)', 'Fórmula: 1-♭3-♭5-♭7. Aparece no 7º grau do campo harmônico maior', 'p.42']], exemplos: [{ sessionIndex: 1, items: [{ label: 'Formação 1-7-3-5 (m7)', img: '/images/dia-07/formacao-4-1-m7.png', notes: 'D-F-A-C' }, { label: 'Formação 1-5-7-3 (m7)', img: '/images/dia-07/formacao-4-2-m7.png', notes: 'D-F-A-C' }] }, { sessionIndex: 0, items: [{ label: 'Formação 1-7-3-5 (7)', img: '/images/dia-07/formacao-4-1-7.png', notes: 'G-B-D-F' }, { label: 'Formação 1-5-7-3 (7)', img: '/images/dia-07/formacao-4-2-7.png', notes: 'G-B-D-F' }] }], tip: 'Decore: Imaj7 - iim7 - iiim7 - IVmaj7 - V7 - vim7 - viim7♭5. É o campo harmônico que rege o jazz e a MPB.' },
      { n: 'Dia 8', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Todas as tétrades do campo harmônico de C maior, 3 inversões cada', sess: [['Cifragem moderna', 'Entender C7, Cmaj7, Cm7, CmM7, C7M, Cdim7, C°, C+', 'p.43-44'], ['Símbolos e abreviações', 'Diferença entre C7 e Cmaj7. Atenção aos símbolos: Δ, -, °, ø', 'p.45'], ['Exercício de leitura', 'Ler progressões cifradas e identificar a qualidade de cada acorde', 'p.46']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Formação 1-3-5-7 (7M)', img: '/images/dia-08/formacao-4-3-7m.png', notes: 'C-E-G-B' }, { label: 'Formação 1-3-5-7 (m7)', img: '/images/dia-08/formacao-4-3-m7.png', notes: 'C-Eb-G-Bb' }, { label: 'Formação 1-3-5-7 (7)', img: '/images/dia-08/formacao-4-3-7.png', notes: 'C-E-G-Bb' }] }, { sessionIndex: 1, items: [{ label: 'Formação 1-5-7-3 (7M)', img: '/images/dia-08/formacao-4-4-7m.png', notes: 'C-E-G-B' }, { label: 'Formação 1-5-7-3 (m7)', img: '/images/dia-08/formacao-4-4-m7.png', notes: 'C-Eb-G-Bb' }, { label: 'Formação 1-5-7-3 (7)', img: '/images/dia-08/formacao-4-4-7.png', notes: 'C-E-G-Bb' }] }], tip: 'Confundir C7 com Cmaj7 é o erro clássico. Um tem ♭7, o outro tem 7 natural. Grave isso.' },
      { n: 'Dia 9', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Ditado harmônico: ouça uma progressão e escreva a cifra', sess: [['Progressões com tétrades', 'ii-V-I em várias tonalidades', 'p.47-48'], ['Substituições básicas', 'Trocar Imaj7 por iii-7, ou vi-7 por I6', 'p.49'], ['Repertório real', 'Analisar standards de jazz: Autumn Leaves, Blue Bossa', 'p.50']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Inversões 7M - Forma 1', img: '/images/dia-09/inversao-5-1-forma1-inv1.png', notes: 'C-E-G-B' }, { label: 'Inversões 7M - Forma 2', img: '/images/dia-09/inversao-5-1-forma2-inv1.png', notes: 'C-E-G-B' }, { label: 'Inversões 7M - Forma 3', img: '/images/dia-09/inversao-5-1-forma3-inv1.png', notes: 'C-E-G-B' }, { label: 'Inversões 7M - Forma 4', img: '/images/dia-09/inversao-5-1-forma4-inv1.png', notes: 'C-E-G-B' }] }], tip: 'Toque os standards devagar, pensando na função harmônica de cada acorde.' },
      { n: 'Dia 10', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Revisão: campo harmônico de 3 tonalidades com tétrades', sess: [['Consolidação geral', 'Refazer exercícios sem consultar. Testar prontidão', 'p.33-50'], ['Teste de reconhecimento', 'Ouvir e identificar tétrades sem ver', 'p.51'], ['Transição para arpejos', 'Entender que vamos começar a tocar as notas separadas agora', 'p.52']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Review: Inversões 7M (Forma 1)', img: '/images/dia-10/revisao-inversoes-7m.png', notes: 'C-E-G-B' }, { label: 'Review: Inversões 7M (Forma 2)', img: '/images/dia-09/inversao-5-1-forma2-inv2.png', notes: 'C-E-G-B' }, { label: 'Review: Inversões 7M (Forma 3)', img: '/images/dia-09/inversao-5-1-forma3-inv3.png', notes: 'C-E-G-B' }, { label: 'Review: Inversões 7M (Forma 4)', img: '/images/dia-09/inversao-5-1-forma4-inv4.png', notes: 'C-E-G-B' }] }], tip: 'Se você dominou até aqui, o restante do livro vai fluir. Se não, volte.', quiz: true }
    ]
  },
  f1b: {
