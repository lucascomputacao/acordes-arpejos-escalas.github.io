const WEEKS = {
  f1: {
    ...
    days: [
      ...
      { n: 'Sábado', off: true },
      { n: 'Domingo', off: true },
      { n: 'Dia 6', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Tríades + agora adicionar a 7ª maior em cima (CEG → CEGB)', sess: [['Tétrade maior com 7ª maior (Cmaj7)', 'Fórmula: 1-3-5-7. Som característico, estável', 'p.33-34'], ['Inversões de tétrades', 'Fundamental, 1ª, 2ª, 3ª inversão. Baixo define a inversão', 'p.35-36'], ['Digitações comuns', 'Formas fechadas e abertas de maj7', 'p.37']], exemplos: [{ sessionIndex: 0, title: 'Formação 1-7-3-5 (fundamental na 6ª corda)', items: [{ label: '7M', img: './public/images/dia-06/formacao-4-1-7m.png', notes: 'C-E-G-B' }] }, { sessionIndex: 0, title: 'Formação 1-5-7-3 (fundamental na 4ª corda)', items: [{ label: '7M', img: './public/images/dia-06/formacao-4-2-7m.png', notes: 'C-E-G-B' }, { label: 'm7', img: './public/images/dia-06/formacao-4-2-m7.png', notes: 'C-Eb-G-Bb' }, { label: 'm7(b5)', img: './public/images/dia-06/formacao-4-2-m7b5.png', notes: 'C-Eb-Gb-Bb' }, { label: '7', img: './public/images/dia-06/formacao-4-2-7.png', notes: 'C-E-G-Bb' }, { label: '7M(♯5)', img: './public/images/dia-06/formacao-4-2-7d5.png', notes: 'C-E-G#-B' }, { label: 'm7M', img: './public/images/dia-06/formacao-4-2-m7m.png', notes: 'C-Eb-G-B' }, { label: '°', img: './public/images/dia-06/formacao-4-2-diminuto.png', notes: 'C-Eb-Gb-Bbb' }] }, { sessionIndex: 1, items: [{ label: 'Inversões Tipo 7M', img: './public/images/dia-06/inversao-forma-1-7m.png', notes: 'C-E-G-B' }] }], tip: 'A 7ª maior "flutua". Você vai ouvir isso em bossa nova o tempo todo.' },
