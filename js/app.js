const WEEKS = {
  f1: {
    ...
    days: [
      ...
      { n: 'Sábado', off: true },
      { n: 'Domingo', off: true },
      { n: 'Dia 6', b: 'ba', bl: 'Acordes', t: '30 min', warm: 'Revisão de tríades + preparação para ver as formações de tétrades', sess: [['Introdução às tétrades', 'Adicionando a 7ª aos acordes. Visão das 4 posições básicas', 'p.33-36']], tip: 'Aprenda as 4 posições básicas de tétrades. Cada uma tem uma sonoridade e um contexto de uso diferente.' },
      { n: 'Dia 6b', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Tríades + agora adicionar a 7ª maior em cima (CEG → CEGB)', sess: [['Tétrade maior com 7ª maior (Cmaj7)', 'Fórmula: 1-3-5-7. Som característico, estável', 'p.33-34'], ['Inversões de tétrades', 'Fundamental, 1ª, 2ª, 3ª inversão. Baixo define a inversão', 'p.35-36'], ['Digitações comuns', 'Formas fechadas e abertas de maj7', 'p.37']], exemplos: [{ sessionIndex: 0, title: 'Cmaj7', items: [{ notes: 'C-E-G-B', chordAtlas: { structure: 'Tétrade maior 7ª maior', category: 'Acordes', minFret: 0, maxFret: 24, root: 'C' } }] }], tip: 'A 7ª maior "flutua". Você vai ouvir isso em bossa nova o tempo todo.' },
      { n: 'Dia 7', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Sequência Cmaj7-Dm7-G7-Cmaj7 em loop, explorando inversões', sess: [['Acorde dominante (G7)', 'Fórmula: 1-3-5-♭7. Função: tenso, quer resolver', 'p.38-39'], ['Acorde menor com 7ª menor (Dm7)', 'Fórmula: 1-♭3-5-♭7. Som suave, contexto de ii-V-I', 'p.40-41'], ['Acorde meio-diminuto (Bm7♭5)', 'Fórmula: 1-♭3-♭5-♭7. Aparece no 7º grau do campo harmônico maior', 'p.42']], exemplos: [{ sessionIndex: 0, title: 'G7', items: [{ notes: 'G-B-D-F', chordAtlas: { structure: 'Tétrade dominante 7', category: 'Acordes', minFret: 0, maxFret: 24, root: 'G' } }] }, { sessionIndex: 1, title: 'Dm7', items: [{ notes: 'D-F-A-C', chordAtlas: { structure: 'Tétrade menor 7', category: 'Acordes', minFret: 0, maxFret: 24, root: 'D' } }] }, { sessionIndex: 2, title: 'Bm7b5', items: [{ notes: 'B-D-F-A', chordAtlas: { structure: 'Tétrade meio-diminuta m7b5', category: 'Acordes', minFret: 0, maxFret: 24, root: 'C' } }] }], tip: 'Decore: Imaj7 - iim7 - iiim7 - IVmaj7 - V7 - vim7 - viim7♭5. É o campo harmônico que rege o jazz e a MPB.' },
  ...
  f2: {
    ...
    days: [
      { n: 'Sábado', off: true },
      { n: 'Domingo', off: true },
      { n: 'Dia 21', b: 'bp', bl: 'Escalas', t: '40 min', warm: 'Escala de C maior em 5 posições, padrão CAGED', sess: [['Escala maior — revisão', 'Fórmula: T-T-sT-T-T-T-sT. Construção intervalar', 'p.63-64'], ['Digitações completas', '7 posições cobrindo o braço inteiro', 'p.65-66'], ['Estudo melódico', 'Criar linhas usando só a escala maior', 'p.67']], exemplos: [{ sessionIndex: 0, title: 'C Major Scale', items: [{ notes: 'C-D-E-F-G-A-B', chordAtlas: { structure: 'Escala maior', category: 'Escalas', minFret: 0, maxFret: 24, root: 'C' } }] }], tip: 'Decore as 5 (ou 7) posições. Você precisa conhecer o braço como a palma da mão.' },
      { n: 'Dia 22', b: 'bp', bl: 'Escalas', t: '40 min', warm: 'Sequência 1-2-3, 2-3-4, 3-4-5... na escala maior', sess: [['Escala menor natural', 'Fórmula: T-sT-T-T-sT-T-T. Relativa menor', 'p.68-69'], ['Escala menor harmônica', '♯7 na menor natural. Som "exótico"', 'p.70-71'], ['Escala menor melódica', '♯6 e ♯7 na menor natural. "Maior com ♭3"', 'p.72']], exemplos: [{ sessionIndex: 0, title: 'C Natural Minor Scale', items: [{ notes: 'C-D-Eb-F-G-Ab-Bb', chordAtlas: { structure: 'Escala menor natural', category: 'Escalas', minFret: 0, maxFret: 24, root: 'C' } }] }, { sessionIndex: 1, title: 'C Harmonic Minor Scale', items: [{ notes: 'C-D-Eb-F-G-Ab-B', chordAtlas: { structure: 'Escala menor harmônica', category: 'Escalas', minFret: 0, maxFret: 24, root: 'C' } }] }, { sessionIndex: 2, title: 'C Melodic Minor Scale', items: [{ notes: 'C-D-Eb-F-G-A-B', chordAtlas: { structure: 'Escala menor melódica', category: 'Escalas', minFret: 0, maxFret: 24, root: 'C' } }] }], tip: 'Menor melódica é a escala do jazz menor. Você vai viver nela quando tocar m(maj7).' },
      ...
      { n: 'Sábado', off: true },
      { n: 'Domingo', off: true },
      { n: 'Dia 26', b: 'bm', bl: 'Modos', t: '45 min', warm: 'Escala de C maior começando em cada grau (C D E F G A B)', sess: [['Conceito de modos', 'Mesmo conjunto de notas, tônicas diferentes', 'p.79-80'], ['Jônico e dórico', 'Jônico = escala maior. Dórico = menor com 6ª maior', 'p.81-82'], ['Som característico de cada modo', 'Ouvir e sentir a "personalidade" do dórico', 'p.83']], exemplos: [{ sessionIndex: 1, title: 'C Ionian', items: [{ notes: 'C-D-E-F-G-A-B', chordAtlas: { structure: 'Modo Jônico', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }, { sessionIndex: 1, title: 'C Dorian', items: [{ notes: 'C-D-Eb-F-G-A-Bb', chordAtlas: { structure: 'Modo Dórico', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }], tip: 'Modo não é só padrão de dedos. É um universo sonoro. Ouça muito!' },
      { n: 'Dia 27', b: 'bm', bl: 'Modos', t: '45 min', warm: 'Tocar D dórico (notas de C maior começando em D)', sess: [['Frígio e lídio', 'Frígio: menor com ♭2. Lídio: maior com ♯4', 'p.84-85'], ['Aplicação em acordes', 'Dórico sobre m7, frígio sobre m7 também (depende do contexto)', 'p.86-87'], ['Improvisar modalmente', 'Praticar sobre um acorde estático de Dm7 com dórico', 'p.88']], exemplos: [{ sessionIndex: 0, title: 'C Phrygian', items: [{ notes: 'C-Db-Eb-F-G-Ab-Bb', chordAtlas: { structure: 'Modo Frígio', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }, { sessionIndex: 0, title: 'C Lydian', items: [{ notes: 'C-D-E-F#-G-A-B', chordAtlas: { structure: 'Modo Lídio', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }], tip: 'Lídio sobre maj7 é lindo. Ouça músicas de Chick Corea, Herbie Hancock.' },
      { n: 'Dia 28', b: 'bm', bl: 'Modos', t: '45 min', warm: 'Todos os 7 modos da escala maior em C (começando em C, D, E, F, G, A, B)', sess: [['Mixolídio e eólio', 'Mixolídio: maior com ♭7 (escala do dominante). Eólio: menor natural', 'p.89-90'], ['Lócrio', 'Meio-diminuto. Raramente usado como tônico', 'p.91'], ['Quadro geral dos 7 modos', 'Jônico, dórico, frígio, lídio, mixolídio, eólio, lócrio', 'p.92']], exemplos: [{ sessionIndex: 0, title: 'C Mixolydian', items: [{ notes: 'C-D-E-F-G-A-Bb', chordAtlas: { structure: 'Modo Mixolídio', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }, { sessionIndex: 0, title: 'C Aeolian', items: [{ notes: 'C-D-Eb-F-G-Ab-Bb', chordAtlas: { structure: 'Modo Eólio', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }, { sessionIndex: 1, title: 'C Locrian', items: [{ notes: 'C-Db-Eb-F-Gb-Ab-Bb', chordAtlas: { structure: 'Modo Lócrio', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }, { sessionIndex: 1, title: 'C Super Locrian', items: [{ notes: 'C-Db-Eb-Fb-Gb-Ab-Bb', chordAtlas: { structure: 'Super Lócrio/Alterada', category: 'Modos', minFret: 0, maxFret: 24, root: 'C' } }] }], tip: 'Decore a ordem e as características. Isso é linguagem universal do jazz.' },
...
function generateChordAtlasUrl(example, category = 'Acordes') {
  ...
  const fullUrl = `./chord-atlas/#/${categorySlug}/${structureSlug}?${params.toString()}`;
...
function buildDay(day, qk, dayIndex) {
  ...
  const sesHtml = day.sess.map((s, sesIndex) => {
    ...
    const exemplosHtml = sesExemplosFormacoes.length > 0 ? sesExemplosFormacoes.map((formacao, formacaoIdx) => {
      ...
      <div class="chordatlas-buttons-group" style="margin-bottom: 9px;">
      ...
      ` : ''}
      ${formacao.items.some(ex => ex.chordName) ? `
      <div class="examples-grid">
        ${formacao.items.map((ex, itemIdx) => {
          const itemId = `${formacaoId}-${itemIdx}`;

          // Renderizar apenas SVGuitar items
          if (ex.chordName) {
            return `
