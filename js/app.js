        ...
        exemplos: [
          {
            sessionIndex: 0,
            items: [
              { label: 'Dm7 - Formação', img: '/images/dia-01/dm7-prog1.png', notes: 'D-F-A-C' },
              { label: 'G7 - Dominante', img: '/images/dia-01/g7-prog1.png', notes: 'G-B-D-F' },
              { label: 'C7M - Maior 7ª', img: '/images/dia-01/c7m-prog1.png', notes: 'C-E-G-B' }
            ]
          }
        ],
        tip: 'Use um diapasão em branco para marcar as notas de cada tríade. Enxergue o "triângulo" do acorde no braço.'
      },
      { n: 'Dia 2', b: 'ba', bl: 'Acordes', t: '30 min', warm: 'Sequência I-IV-V em C maior com tríades apenas (C-F-G)', sess: [['Tríades menores', 'Diferença pro maior: 3ª menor (♭3). Fórmula: 1-♭3-5', 'p.19-20'], ['Inversões de tríades menores', 'Mesma lógica das maiores: fundamental, 1ª inversão, 2ª inversão', 'p.20-21'], ['Ditado de tríades', 'Ouça acordes de músicas conhecidas e identifique maior ou menor', 'p.22']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Em7 - Menor 7ª', img: '/images/dia-02/em7-prog2.png', notes: 'E-G-B-D' }, { label: 'A7 - Dominante', img: '/images/dia-02/a7-prog2.png', notes: 'A-C#-E-G' }, { label: 'D7M - Maior 7ª', img: '/images/dia-02/d7m-prog2.png', notes: 'D-F#-A-C#' }] }], tip: 'Ouça sons de violão ou piano tocando tríades. Tente identificar de ouvido se é maior ou menor antes de ver a cifra.' },
      { n: 'Dia 3', b: 'ba', bl: 'Acordes', t: '30 min', warm: 'Toque as 3 inversões de C, Dm, Em, F, G, Am em sequência', sess: [['Tríades diminutas e aumentadas', 'Diminuta: 1-♭3-♭5. Aumentada: 1-3-♯5', 'p.23-24'], ['Campo harmônico em tríades', 'Construir as tríades dos 7 graus da escala maior', 'p.25-26'], ['Progressões diatônicas', 'I-vi-IV-V, I-IV-V, ii-V-I em tríades', 'p.27']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Am7 - Menor 7ª', img: '/images/dia-03/am7-prog3.png', notes: 'A-C-E-G' }, { label: 'D7 - Dominante', img: '/images/dia-03/d7-prog3.png', notes: 'D-F#-A-C' }, { label: 'G7M - Maior 7ª', img: '/images/dia-03/g7m-prog3.png', notes: 'G-B-D-F#' }] }], tip: 'Decore o padrão do campo harmônico maior: M m m M M m dim. Você vai usar isso pra sempre.' },
      { n: 'Dia 4', b: 'ba', bl: 'Acordes', t: '30 min', warm: 'Campo harmônico de C maior em tríades, todas as inversões, subindo o braço', sess: [['Encadeamentos de inversões', 'Movimentação suave entre acordes usando inversões', 'p.28-29'], ['Prática: progressão em todas as tonalidades', 'I-IV-V em C, G, D, A, E, F, B♭', 'p.30'], ['Análise de música real', 'Pegue uma música simples e identifique as tríades', 'p.31']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Dm7 - Menor 7ª', img: '/images/dia-04/dm7-prog4.png', notes: 'D-F-A-C' }, { label: 'Em7(11) - Extensão', img: '/images/dia-04/em7-prog4.png', notes: 'E-G-B-D-A' }, { label: 'G7(♯5) - Alterado', img: '/images/dia-04/g7-prog4.png', notes: 'G-B-D#-F' }, { label: 'C7M(9) - Extensão', img: '/images/dia-04/c7m-prog4.png', notes: 'C-E-G-B-D' }] }], tip: 'Escolha uma música que você goste e que tenha poucos acordes. Tente tocar só com tríades e inversões.' },
      { n: 'Dia 5', b: 'ba', bl: 'Acordes', t: '30 min', warm: 'Revisão livre: toque tríades em diferentes regiões do braço sem olhar cifras', sess: [['Consolidação das inversões', 'Refazer todos os exemplos das páginas anteriores sem consultar', 'p.14-31'], ['Teste de prontidão', 'Consegue tocar qualquer tríade em qualquer inversão sem pensar?', 'p.31'], ['Preparação para tétrades', 'Compreender que vamos adicionar a 7ª agora', 'p.32']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Dm7(b5) - Meio-diminuto', img: '/images/dia-05/dm7b5-prog5.png', notes: 'D-F-A-C' }, { label: 'G7 - Dominante', img: '/images/dia-05/g7-prog5.png', notes: 'G-B-D-F' }, { label: 'Cm7 - Menor 7ª', img: '/images/dia-05/cm7-prog5.png', notes: 'C-Eb-G-Bb' }] }], tip: 'Se não conseguir tocar de cor, volte atrás. Melhor consolidar pouco do que avançar com lacunas.', quiz: true },
      { n: 'Sábado', off: true },
      { n: 'Domingo', off: true },
      { n: 'Dia 6', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Tríades + agora adicionar a 7ª maior em cima (CEG → CEGB)', sess: [['Tétrade maior com 7ª maior (Cmaj7)', 'Fórmula: 1-3-5-7. Som característico, estável', 'p.33-34'], ['Inversões de tétrades', 'Fundamental, 1ª, 2ª, 3ª inversão. Baixo define a inversão', 'p.35-36'], ['Digitações comuns', 'Formas fechadas e abertas de maj7', 'p.37']], exemplos: [{ sessionIndex: 0, items: [{ label: 'C7M - Maior 7ª', img: '/images/dia-01/c7m-prog1.png', notes: 'C-E-G-B' }] }], tip: 'A 7ª maior "flutua". Você vai ouvir isso em bossa nova o tempo todo.' },
      { n: 'Dia 7', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Sequência Cmaj7-Dm7-G7-Cmaj7 em loop, explorando inversões', sess: [['Acorde dominante (G7)', 'Fórmula: 1-3-5-♭7. Função: tenso, quer resolver', 'p.38-39'], ['Acorde menor com 7ª menor (Dm7)', 'Fórmula: 1-♭3-5-♭7. Som suave, contexto de ii-V-I', 'p.40-41'], ['Acorde meio-diminuto (Bm7♭5)', 'Fórmula: 1-♭3-♭5-♭7. Aparece no 7º grau do campo harmônico maior', 'p.42']], exemplos: [{ sessionIndex: 0, items: [{ label: 'G7 - Dominante', img: '/images/dia-01/g7-prog1.png', notes: 'G-B-D-F' }] }, { sessionIndex: 1, items: [{ label: 'Dm7 - Menor 7ª', img: '/images/dia-01/dm7-prog1.png', notes: 'D-F-A-C' }] }], tip: 'Decore: Imaj7 - iim7 - iiim7 - IVmaj7 - V7 - vim7 - viim7♭5. É o campo harmônico que rege o jazz e a MPB.' },
      { n: 'Dia 8', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Todas as tétrades do campo harmônico de C maior, 3 inversões cada', sess: [['Cifragem moderna', 'Entender C7, Cmaj7, Cm7, CmM7, C7M, Cdim7, C°, C+', 'p.43-44'], ['Símbolos e abreviações', 'Diferença entre C7 e Cmaj7. Atenção aos símbolos: Δ, -, °, ø', 'p.45'], ['Exercício de leitura', 'Ler progressões cifradas e identificar a qualidade de cada acorde', 'p.46']], exemplos: [{ sessionIndex: 0, items: [{ label: 'C7M vs G7 - Comparação', img: '/images/dia-02/d7m-prog2.png', notes: 'D-F#-A-C# vs G-B-D-F' }] }], tip: 'Confundir C7 com Cmaj7 é o erro clássico. Um tem ♭7, o outro tem 7 natural. Grave isso.' },
      { n: 'Dia 9', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Ditado harmônico: ouça uma progressão e escreva a cifra', sess: [['Progressões com tétrades', 'ii-V-I em várias tonalidades', 'p.47-48'], ['Substituições básicas', 'Trocar Imaj7 por iii-7, ou vi-7 por I6', 'p.49'], ['Repertório real', 'Analisar standards de jazz: Autumn Leaves, Blue Bossa', 'p.50']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Dm7-G7-Cmaj7', img: '/images/dia-01/dm7-prog1.png', notes: 'Dm7-G7-Cmaj7' }] }], tip: 'Toque os standards devagar, pensando na função harmônica de cada acorde.' },
      { n: 'Dia 10', b: 'ba', bl: 'Acordes', t: '35 min', warm: 'Revisão: campo harmônico de 3 tonalidades com tétrades', sess: [['Consolidação geral', 'Refazer exercícios sem consultar. Testar prontidão', 'p.33-50'], ['Teste de reconhecimento', 'Ouvir e identificar tétrades sem ver', 'p.51'], ['Transição para arpejos', 'Entender que vamos começar a tocar as notas separadas agora', 'p.52']], exemplos: [{ sessionIndex: 0, items: [{ label: 'Progressão ii-V-I', img: '/images/dia-03/am7-prog3.png', notes: 'Am7-D7-G7M' }] }], tip: 'Se você dominou até aqui, o restante do livro vai fluir. Se não, volte.', quiz: true }
    ]
  },
  f1b: {
