...
const SCALE_SUGGESTIONS={
  ...
  'Tétrade aumentada 7M(#5)':[
    {cat:'Escalas',name:'Escala menor melódica',whyPt:'III grau (lídio aumentado) contém 3, #5 e 7M',whyEn:'III degree (Lydian augmented) contains 3, #5 and maj7'},
    {cat:'Escalas',name:'Escala menor harmônica',whyPt:'III grau da menor harmônica gera maj7(#5)',whyEn:'III degree of harmonic minor yields maj7(#5)'},
    {cat:'Escalas',name:'Tons inteiros',whyPt:'contém 3 e #5; cor aumentada simétrica',whyEn:'contains 3 and #5; symmetric augmented color'}
  ],
...
const COMPATIBLE_CHORDS={
  ...
  'Escala menor harmônica':[
    ...
    {name:'Tétrade aumentada 7M(#5)',whyPt:'III grau da menor harmônica',whyEn:'III degree of harmonic minor'},
...
const TENSION_DATA={
  ...
  'Tétrade aumentada 7M(#5)':{stable:['9','#11'],context:['#9','b7'],avoid:['5 natural','b13'],pt:'O #5 define a cor aumentada. #11 reforça o som lídio aumentado. Evite a 5 natural e a b13 para não contradizer o #5.',en:'The #5 defines the augmented color. #11 reinforces the Lydian augmented sound. Avoid natural 5 and b13 to not contradict the #5.'},
...
const BOOK_ARPEGGIO_PATTERNS = {
  ...
  'Arpejo tétrade aumentada': [
    {
      ...
      // and removed the D-string #5 (fret 6).
      offsets: [
        {string:6, fret:4, interval:'#5'},
        {string:5, fret:2, interval:'7M'},
        {string:5, fret:3, interval:'T'},
    ...
    },
    {
      name: 'Position 3',
      baseForC: 8,
      // Corrected per user diagram: removed the A-string #5 and added the
      // D-string #5 below the 7M.
      offsets: [
        {string:6, fret:-1, interval:'7M'},
        {string:6, fret:0, interval:'T'},
        {string:5, fret:-1, interval:'3'},
  ...
  'Arpejo menor com sétima maior': [
    ...
    },
    {
      name: 'Position 2',
      baseForC: 5,
      // Corrected per user diagram: removed the D-string 7M and added the
      // G-string 7M just below the root.
      offsets: [
        {string:6, fret:2, interval:'7M'},
        {string:6, fret:3, interval:'T'},
        {string:5, fret:1, interval:'b3'},
    ...
    },
    {
      name: 'Position 3',
      baseForC: 5,
      // Corrected per user diagram: removed the top-E b3 and the B-string 7M,
      // added the top-E 7M just below the root.
      offsets: [
        {string:6, fret:3, interval:'T'},
        {string:6, fret:6, interval:'b3'},
        {string:5, fret:5, interval:'5'},
